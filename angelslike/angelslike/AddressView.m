...
-(void)initialAddress{
    ...
    [self addSubview:[self labelName:@"姓名" frame:CGRectMake(10, 10, 100, 30)]];
    [self addSubview:[self labelName:@"电话" frame:CGRectMake(10, 50, 100, 30)]];
    ...
    [self addSubview:[self textField:CGRectMake(self.frame.size.width / 3, 130, self.frame.size.width / 3 * 2 - 10, 30) withTag:13]];
}


-(void)textChange:(UITextField *)textField{
    NSArray *arr = @[@"name",@"phone",@"address"];
