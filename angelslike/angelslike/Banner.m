...
//    [self addSubview:rightTitle];
    ...
    UIImageView *leftImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width / 2  , self.frame.size.height)];
...
//    [self addSubview:leftV];
    ...
    UIImageView *rightImage = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width / 2, 0, self.frame.size.width / 2  , self.frame.size.height)];
